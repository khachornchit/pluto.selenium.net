...
{
    public class CustomerCareRepresentativeThai : IApplicantProcess
    {
        public static string Name { get { return "Customer Care Representative Thai"; } }
        public List<TestResultInPage> TestResultInPages { get; set; }
        private string TestName { get; set; }
        public static string Url { get { return "http://www.clbs.co.th/lp/customer-care-representative-thai.html"; } }
        public static string JobName { get { return Name; } }
        public static string JobAlias { get { return "CC_Agent_Th"; } }

        public CustomerCareRepresentativeThai()
        {
