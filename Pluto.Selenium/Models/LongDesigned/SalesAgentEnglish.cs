...
{
    public class SalesAgentEnglish : IApplicantProcess
    {
        public static string Name { get { return "Sales Agent English"; } }
        public List<TestResultInPage> TestResultInPages { get; set; }
        private string TestName { get; set; }
        public static string Url { get { return "http://www.clbs.co.th/lp/sales-agent-english.html"; } }
        public static string JobName { get { return Name; } }
        public static string JobAlias { get { return "Sales_Agent_En"; } }

        public SalesAgentEnglish()
        {
