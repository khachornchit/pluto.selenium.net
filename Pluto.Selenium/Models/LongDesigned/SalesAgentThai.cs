...
{
    public class SalesAgentThai : IApplicantProcess
    {
        public static string Name { get { return "Sales Agent Thai"; } }
        public List<TestResultInPage> TestResultInPages { get; set; }
        private string TestName { get; set; }
        public static string Url { get { return "http://www.clbs.co.th/lp/sales-agent-thai.html"; } }
        public static string JobName { get { return Name; } }
        public static string JobAlias { get { return "Sales_Assist"; } }

        public SalesAgentThai()
        {
